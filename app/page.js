        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <section className={styles.saveTheDateNotice}>
                    <p>
                        We’ve found our perfect coordinates, and we’re not wasting a single frame! We are tying the knot
                        this year. <br/><br/>
                        We would love nothing more than to have you in the picture with us. If you’re planning to
                        celebrate by our side, please drop your address below so we can pin you on our map.
                    </p>
                </section>
